    ...
    <div className="footer-bg">
      <div className="footer-top">
        <div className="footer-info">
          ...
          <p>
            FragranceHub is an e-commerce platform specializing in selling
            perfumes. FragranceHub offer a wide range of fragrances from various
            brands, catering to different preferences and budgets.
          </p>
        </div>
